        ...
        <div>
            <nav className={`navbar navbar-expand-lg bg-${props.mode=== 'light'?'danger': 'dark'} text-${props.mode=== 'light'?'dark': 'light'}`}>
                <div className="container-fluid">
                    <a className={`navbar-brand my-1 mx-3 text-${props.mode=== 'light'?'dark': 'light'}`} href="/"><b>{props.tittle}</b></a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className={`nav-link menu1 active mx-3 mx-3 text-${props.mode=== 'light'?'dark': 'light'}`} aria-current="page" href="/"><b className='menu1'>Home</b></a>
                            </li>
                            <li className="nav-item ">
                                <a className={`nav-link menu1 mx-3 mx-3 text-${props.mode=== 'light'?'dark': 'light'}`} href="/about"><b className='menu1'>About Us</b></a>
                            </li>
